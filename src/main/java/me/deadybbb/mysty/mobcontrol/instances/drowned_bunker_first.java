...
@CustomZonePrefix("drowned_bunker_first")
public class drowned_bunker_first implements Listener {
    ...
    public void onZoneTick(ZoneTickEvent event) {
        ...
        for (Location loc : spawnLoc) {
            Drowned en = (Drowned) world.spawnEntity(loc, mob, CreatureSpawnEvent.SpawnReason.CUSTOM);
